...
from pma.requests.stock_list import StockListInvalidRequest
...
def test_response_failure_from_empty_invalid_request():
    response = build_response_from_invalid_request(StockListInvalidRequest())
...
def test_response_failure_from_invalid_request_with_errors():
    request = StockListInvalidRequest()
